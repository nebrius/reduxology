...
export declare type MapStateToProps = (getSlice: (slice: string) => any, ownProps?: any) => any;
export declare type MapDispatchToProps = (dispatch: (action: string, ...data: any[]) => void, ownProps?: any) => any;
